...
// [AMIGO-PATCH] Removed `import io.flutter.plugin.common.PluginRegistry.Registrar`
// — `Registrar` is part of the deprecated Flutter v1 embedding which has
// been fully removed in current Flutter SDKs, breaking the release build.
// The symbol was only ever imported (never referenced) elsewhere in this
// file, so dropping it is safe.
import java.util.*
